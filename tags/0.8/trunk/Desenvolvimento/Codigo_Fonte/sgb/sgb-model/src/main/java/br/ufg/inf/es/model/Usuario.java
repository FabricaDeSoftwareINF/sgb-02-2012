...
public class Usuario extends AbstractEntityModel {
    ...
    /**
	 * Obtém o valor do campo <code>dataCadastros</code>
	 *
	 * @return {@link Date}
	 */
	...
	/**
	 * Obtém o valor do campo <code>email</code>
	 *
	 * @return {@link String}
	 */
	...
	/**
	 * Define o campo <code>email</code>.
	 *
	 * @param email 
	 */
	...
	/**
	 * Obtém o valor do campo <code>confirmacaoEmail</code>
	 *
	 * @return {@link String}
	 */
	...
	/**
	 * Define o campo <code>confirmacaoEmail</code>.
	 *
	...
	/**
	 * Obtém o valor do campo <code>status</code>
	 *
	 * @return {@link boolean}
	 */
	...
	/**
	 * Define o campo <code>status</code>.
	 *
	 * @param status 
	 */
	...
	/**
	 * Obtém o valor do campo <code>perfil</code>
	 *
	...
	/**
	 * Define o campo <code>perfil</code>.
	 *
	 * @param perfil 
	 */
