...
/**
 * Classe responsável por definir um modelo de tabela para Usuário selecionável
 * dentro da DataTable.
 *
 * @author Cássio Augusto Silva de Freitas
 */
public class UsuarioDataModel extends ListDataModel<Usuario>
        implements SelectableDataModel<Usuario>, Serializable {
    ...
    /**
     * Método responsábel por obter a chave identificadora do objeto na linha
     * selecionada.
     *
     * @param autor
