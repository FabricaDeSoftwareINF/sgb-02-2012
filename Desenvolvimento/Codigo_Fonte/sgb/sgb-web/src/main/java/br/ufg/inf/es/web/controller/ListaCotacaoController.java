...
//        List<Cotacao> cotacoes = new ArrayList(form.getEntity().getCotacoes());
//        for (int i = 0; i < form.getEntity().getCotacoes().size(); i++) {
//            
//            ItemPlanilha itemPlanilha = montarItemPlanilha(cotacoes.get(i), i + 1);
//
//            if (cotacoes.get(i).getLivro().isEstrangeiro() == false) {
...
//        for (int i = 0; i < form.getEntity().getCotacoes().size(); i++) {
//
//            if (cotacoes.get(i).getLivro().isEstrangeiro() == true) {
//
//                ItemPlanilha itemPlanilha = montarItemPlanilha(cotacoes.get(i), i + 1);
//                linhasPlanilhaEstrangeiros.add(itemPlanilha);
//            }
